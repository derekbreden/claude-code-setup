...
| --- | --- | --- |
| `hooks/` | Bash guardrail hooks (Stop, SubagentStop, PreToolUse, PostToolUse, UserPromptSubmit, SessionStart) — effort estimates, residue, the relay inbox, abandoned forks, etc. | referenced by absolute path from `~/.claude/settings.json` |
