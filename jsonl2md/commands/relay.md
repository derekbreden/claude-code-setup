---
description: Pull other Claude Code sessions' clean transcripts INTO this one — renders them with jsonl2md and reads them in. Local only; no cross-session messaging.
