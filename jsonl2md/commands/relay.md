...
If you need an answer, include your own id with `--reply-to`. Live replies steer a working agent or wake an idle one; no watcher is needed. `/relay-send` describes the routes and explicit legacy mailbox option.
