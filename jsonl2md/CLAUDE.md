jsonl2md is the export tool; the user's main work lives in homesodamachine (the home soda machine appliance). It exports Claude conversations and Codex task dialogue to `.md`, often re-fed into another task as clean context. DEFAULT_CWD in jsonl2md.py points at `/Users/derekbredensteiner/Developer/homesodamachine`. The README and jsonl2md.py cover what this tool does.
